...
export function ToolCard({ tool }: { tool: ToolDefinition }) {
  ...
  return (
    <Link
      ...
      className="group relative flex h-full flex-col rounded-2xl border border-slate-200/80 bg-white/80 p-5 shadow-[0_12px_30px_-24px_rgba(15,23,42,0.45)] transition duration-300 hover:-translate-y-0.5 hover:border-teal-300/70 hover:shadow-[0_18px_40px_-24px_rgba(15,118,110,0.45)]"
    >
